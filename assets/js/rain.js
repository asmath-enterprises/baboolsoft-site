      ...
      function (t, e, i) {
        ...
        function n() {
          (0, y["default"])([
            {
              name: "dropAlpha",
              src: "assets/img/drop-alpha.png",
            },
            {
              name: "dropColor",
              src: "assets/img/drop-color.png",
            },
            {
              name: "textureRainFg",
              src: "assets/img/weather/texture-rain-fg.png",
            },
            {
              name: "textureRainBg",
              src: "assets/img/weather/texture-rain-bg.png",
            },
            {
              name: "textureStormLightningFg",
              src: "assets/img/weather/texture-storm-lightning-fg.png",
            },
            {
              name: "textureStormLightningBg",
              src: "assets/img/weather/texture-storm-lightning-bg.png",
            },
            {
              name: "textureFalloutFg",
              src: "assets/img/weather/texture-fallout-fg.png",
            },
            {
              name: "textureFalloutBg",
              src: "assets/img/weather/texture-fallout-bg.png",
            },
            {
              name: "textureSunFg",
              src: "assets/img/weather/texture-sun-fg.png",
            },
            {
              name: "textureSunBg",
              src: "assets/img/weather/texture-sun-bg.png",
            },
            {
              name: "textureDrizzleFg",
              src: "assets/img/weather/texture-drizzle-fg.png",
            },
            {
